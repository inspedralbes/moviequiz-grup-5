...
try {
    ...
    //$player->insert()
        ...
        $query = $connection->prepare("INSERT INTO pelicula ( titulo, añoProd,poster,comentari,favorit,valoracio) VALUES (:idPeli,:titulo,:anyo,:poster)");
        ...
        $query = $connection->prepare("INSERT INTO valoracio_pelicules (comentari,favorit,valoracio) VALUES (:favorito,:valoracion,:comentario)");
